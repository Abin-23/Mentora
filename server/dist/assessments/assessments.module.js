...
exports.AssessmentsModule = AssessmentsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [assessments_service_1.AssessmentsService, ai_generation_service_1.AiGenerationService, prisma_service_1.PrismaService],
        exports: [assessments_service_1.AssessmentsService, ai_generation_service_1.AiGenerationService],
    })
], AssessmentsModule);
