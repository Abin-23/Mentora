...
let TopicsController = class TopicsController {
    ...
    create(courseId, createTopicDto) {
    ...
    reorder(courseId, reorderTopicsDto) {
...
__decorate([
    ...
    (0, common_1.Post)('courses/:courseId/topics'),
...
__decorate([
    (0, common_1.Get)('courses/:courseId/topics'),
    __param(0, (0, common_1.Param)('courseId', common_1.ParseIntPipe)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", void 0)
], TopicsController.prototype, "findAllByCourse", null);
__decorate([
    (0, roles_decorator_1.Roles)('SystemAdmin', 'CourseAdmin'),
    (0, common_1.Patch)('courses/:courseId/topics/reorder'),
    __param(0, (0, common_1.Param)('courseId', common_1.ParseIntPipe)),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, reorder_topics_dto_1.ReorderTopicsDto]),
    __metadata("design:returntype", void 0)
