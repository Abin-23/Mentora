    ...
    const categories = [
        {
            ...
            description: 'Learn to build modern, responsive, and robust websites and web applications.',
            icon: 'code',
            status: 'Active',
        ...
        },
        {
            ...
            description: 'Design beautiful, intuitive interfaces and craft amazing user experiences.',
            icon: 'brush',
            status: 'Active',
            created_by: admin.user_id,
        },
        ...
        },
        {
            ...
            description: 'Learn to protect networks, devices, programs, and data from attacks.',
            icon: 'security',
            status: 'Active',
            created_by: admin.user_id,
        },
